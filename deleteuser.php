  ...
  <div class="box">
    <div class="box-body">
      <div class="box-header">
        <div class="col-md-10">
        <h3 class="view_head"><b>DELETE - USERS DATA</b></h3>
	   ...
	   <input type="text" name="fname" id="fname" value="<?php echo $user_data["f_name"];?>" class="form-control" readonly>
	   <br>
	   <label for="lname"><b>Last Name</b> </label>
	   <input type="text" name="lname" id="lname" value="<?php echo $user_data["l_name"];?>" class="form-control" readonly>
	  <br>
	  <label for="uemail"><b>Email</b> </label>
	   <input type="text" name="uemail" id="uemail" value="<?php echo $user_data["email"];?>" class="form-control" readonly>
	      
<br>
		<center>  <a href="index.php"> <button type="button" class="btn btn-md w-md orange" >Back to Dashboard</button></a>
	<button class="btn btn-md w-md red" name="deleteuser" id="deleteuser">Delete</button></a>
		</center>		
