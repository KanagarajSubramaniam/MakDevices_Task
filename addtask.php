  ...
  <div class="box">
    <div class="box-body">
      <div class="box-header">
        <div class="col-md-10">
        <h3 class="view_head"><b>ADD - NEW TASK</b></h3>
	   ...
	   <input type="text" name="taskname" id="taskname" value="" class="form-control" autocomplete="off">
	   <br>
	   <label for="targetdate"><b>Target Date</b> </label>
	   <input type="text" name="targetdate" id="targetdate" class="form-control"  autocomplete="off">
	  <br>
	      
<br>
		<center>  <a href="tasks.php"> <button type="button" class="btn btn-md w-md orange" >Back to Tasks List</button></a>
	<button class="btn btn-md w-md green" name="addtask" id="addtask">Add</button></a>
				</center>
