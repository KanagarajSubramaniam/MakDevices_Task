  ...
  <div class="box">
    <div class="box-body">
      <div class="box-header">
        <div class="col-md-10">
        <h3 class="view_head"><b>USERS DATA LIST</b></h3>
	</div>
        ...
        <tbody>
			...
			<?php 
			   $data=mysqli_query($con,"select * from t_user");
			   ...
			   {?>
		        <tr>
                 ...
                 <td>
				   ...
				   <a href="edituser.php?uid=<?php echo $user_data["uid"];?>"> <button class="btn btn-xs w-xs orange" >EDIT</button></a>
					<a href="deleteuser.php?uid=<?php echo $user_data["uid"];?>"><button class="btn btn-xs w-xs red">DELETE</button></a>
				</td>   
				 </tr>
			  <?php } ?>
